  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-6xl mx-auto px-6 pt-20 pb-16 sm:pt-28 sm:pb-20">
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div>
                ...
                <h1 className="text-[44px] sm:text-[60px] lg:text-[68px] font-extrabold text-[#0A0A0A] leading-[1.02] tracking-tight anim-fade-up delay-1 mx-auto">
      ...
      <footer className="border-t border-gray-100 py-12">
        <div className="max-w-6xl mx-auto px-6">
          <div className=ont-semibold uppercase tracking-[0.12em] text-[#9CA3AF] mb-3">What every Waityr gets</p>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0A0A0A] tracking-tight">
                Everything included.
              </h2>
              <p className="text-[#6B7280] mt-3 text-lg">Which is a number, some competition, and a referral link.</p>
